...
from model import cal_similarityTag2,ImgNet,TxtNet
...
class GCFH(object):
    ...
    def _init_dataset(self):
        data_loader = load_dataset(self.config.dataset, self.config.data_pth,self.config.batch_size)
    ...
    def _init_model(self):
        ...
        self.S = cal_similarityTag2(self.config,torch.as_tensor(self.train_loader.dataset.images, dtype=torch.float32),
    ...
    def eval_retrieval(self):
        ...
        with torch.no_grad():
            ...
            for _, (data_I, data_T, data_L, index, tags, len_tags) in enumerate(self.query_loader):
            ...
            for _, (data_I, data_T, data_L,index,tags,len_tags) in enumerate(self.retrieval_loader):
                data_I, data_T = data_I.cuda(), data_T.cuda()
