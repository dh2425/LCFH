...
if __name__ == "__main__":
    ...
    parser.add_argument('--source_images_dir', type=str, default=r"E:\dataset\hashing\MITH\25K\MIRFLICKR-25K-all-images\images", help='')
    ...
    parser.add_argument('--target_images_dir', type=str,default=r'E:\dataset\hashing\MITH\nuswide', help='')
