...
if __name__ == '__main__':
    ...
    parser.add_argument('--evl_epoch', type=int, default=0,help='Number of epochs to start eval')
    parser.add_argument('--k_num', type=int, default=3500)  #flickr 3300 nus 3500  COCO 1000
    parser.add_argument('--scale', type=int, default=4000)  #all 4000
    ...
    parser.add_argument('--eta_1', type=float, default=2) #
    parser.add_argument('--eta_2', type=float, default=2.5)#
    parser.add_argument('--eps_1', type=float, default=3)
    parser.add_argument('--eps_2', type=float, default=4)
    # a=0.5  #coco
    # a=1 #nus
