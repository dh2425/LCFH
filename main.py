...
if __name__ == '__main__':
    ...
    parser.add_argument('--k_num', type=int, default=3500,help='flickr:3100, nus:3500, coco:1000')
    parser.add_argument('--α', type=int, default=4000, help='flickr, nus, coco:2800')
    parser.add_argument('--tag_threshold', type=float, default=0.2, help='flickr:0.17, nus:0.2, coco:0.12')
