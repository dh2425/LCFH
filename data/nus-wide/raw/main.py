...
img_path = 'all/181365_10_imags.txt'
txt_path = 'all/181365_10_txt.txt'
lab_path = 'all/181365_10_label.txt'
...
for label in range(lab_datas.shape[1]):
    ...
    if first:
        ...
        query_index = np.concatenate((query_index, ind[:200]))
